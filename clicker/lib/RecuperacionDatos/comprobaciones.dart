...
Future <bool> ingresarDatosJugador(int mundo, int monstruo, int monedasJugador, int bombas) async{
//Establecemos la conexion
    ...
    var result = await conexion.query("insert into datosJugador (Mundo, Monstruo, Monedas, NumeroBombas) value (?, ?, ?, ? )",
